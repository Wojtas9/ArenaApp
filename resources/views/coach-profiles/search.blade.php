            ...
            <div class="flex-1 p-8 bg-white rounded-2xl shadow-lg">
                ...
                <div class="flex justify-between items-center mb-8">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="relative">
                            <input type="text" id="coach-search" placeholder="Search coaches..."
                                class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#8C508F]">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="coaches-container">
                    @foreach ($coaches as $coach)
                        <div class="coach-card bg-gray-50 rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow"
                            data-coach-name="{{ strtolower($coach->name) }}">
                            <div class="p-6">
                                <div class="flex flex-col items-center mb-4">
                                    ...
                                    @else
                                        <div
                                            class="w-24 h-24 rounded-full bg-[#8C508F] flex items-center justify-center text-white text-3xl mb-3">
                                    ...
                                    @if ($coach->coachProfile->description)
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600 line-clamp-3">
                                                {{ $coach->coachProfile->description }}</p>
                                        </div>
                                    @endif
                                ...
                                <div class="mt-4 flex justify-between items-center">
                                    <a href="{{ route('coach-profiles.show', $coach->id) }}"
                                        class="text-[#8C508F] hover:underline">View Profile</a>
                                    <a href="{{ route('messages.create', ['recipient_id' => $coach->id]) }}"
                                        class="bg-[#8C508F] hover:bg-[#734072] text-white px-3 py-1.5 rounded-lg text-sm transition-colors">
                                        Message Coach
                                    </a>
                                </div>
                            </div>
