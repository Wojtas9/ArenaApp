        ...
        <div class="flex-1 p-8 bg-white rounded-4xl shadow-lg drop-shadow-xl/50 min-h-[500px]">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('training-programs.show', $trainingProgram) }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg">
                        View Program
                    </a>
            ...
            <form method="POST" action="{{ route('training-programs.update', $trainingProgram) }}" id="program-form">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title', $trainingProgram->title) }}" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <select name="status" id="status" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        <option value="active" {{ old('status', $trainingProgram->status) == 'active' ? 'selected' : '' }}>Active</option>
                ...
                <div class="mb-4">
                    ...
                    <div class="bg-white rounded-lg border border-gray-300 p-4">
                        ...
                        <input type="hidden" id="todo_list" name="todo_list" value="{{ old('todo_list', json_encode($trainingProgram->todo_list ?? [])) }}">
                    </div>
                </div>
