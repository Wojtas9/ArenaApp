...
<div class="bg-[#ebebeb] mt-25 p-6 relative overflow-hidden">
    ...
    @include('layouts.partials.sidebar', [
        ...
        <div class="flex-1 p-8 bg-white rounded-4xl shadow-lg drop-shadow-xl/50">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('spots.update', $spot) }}">
                @csrf
                @method('PUT')
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="upload-container relative">
                        ...
                        <div id="imagePreview" class="{{ $spot->picture ? '' : 'hidden' }} mt-2">
                            <div class="relative inline-block">
                                <img src="{{ $spot->picture ? asset($spot->picture) : '#' }}" alt="Preview" class="rounded-lg" style="max-width: 200px;">
...
function removeImage() {
    ...
    preview.src = '{{ $spot->picture ? asset($spot->picture) : "#" }}';
