                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div class="bg-gradient-to-br from-blue-50 to-white p-4 rounded-lg shadow border-l-4 border-blue-500 transform hover:scale-105 transition-all hover:shadow-xl group">
                            <div class="flex justify-between items-start">
                                <div>
                                    <p class="text-md font-semibold text-blue-600 group-hover:text-blue-700">Total Programs</p>
                                    <p class="text-3xl font-bold text-gray-800 mt-2">
                                        {{ \App\Models\TrainingProgram::where('coach_id', auth()->id())->count() }}</p>
                                </div>
                        ...
                        <div class="bg-gradient-to-br from-purple-50 to-white p-4 rounded-lg shadow border-l-4 border-purple-500 transform hover:scale-105 transition-all hover:shadow-xl group">
                            <div class="flex justify-between items-start">
                                <div>
                                    <p class="text-md font-semibold text-purple-600 group-hover:text-purple-700">Total Spots</p>
                                    <p class="text-3xl font-bold text-gray-800 mt-2">
                                        {{ \App\Models\Spot::count() }}
                                    </p>
                                </div>
                                <span class="text-3xl text-purple-500 group-hover:scale-110 transition-transform">🏟️</span>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-yellow-50 to-white p-4 rounded-lg shadow border-l-4 border-yellow-500 transform hover:scale-105 transition-all hover:shadow-xl group">
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-gray-800 mt-2">
                                        {{ \App\Models\Message::where('recipient_id', auth()->id())->count() }}</p>
                                </div>
                        ...
                        <div class="bg-gradient-to-br from-red-50 to-white p-4 rounded-lg shadow border-l-4 border-red-500 transform hover:scale-105 transition-all hover:shadow-xl group">
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-gray-800 mt-2">
                                        {{ \App\Models\Event::where('instructor_id', auth()->id())->count() }}</p>
                                </div>
                    ...
                    <div class="p-6 bg-gray-50 rounded-xl shadow-sm">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="p-4 bg-white rounded-lg shadow-sm">
                                ...
                                <p class="text-2xl font-bold">
                                    {{ \App\Models\TrainingProgram::where('coach_id', auth()->id())->where('status', 'active')->count() }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 bg-gray-50 rounded-xl shadow-sm">
                        ...
                        <div class="space-y-2">
                            <a href="{{ route('training-programs.create') }}"
                                class="block p-3 bg-[#8C508F] text-white rounded-lg hover:bg-[#734072] transition-colors">
                            ...
                            <a href="{{ route('training-programs.index') }}"
                                class="block p-3 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition-colors">
                                <div class="flex items-center gap-3">
                                    <span class="text-xl">📋</span>
                        ...
                        <table class="min-w-full bg-white rounded-lg overflow-hidden">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                @if (\App\Models\TrainingProgram::where('coach_id', auth()->id())->count() == 0)
                                    <tr>
                                        <td colspan="4" class="py-4 px-4 text-center text-gray-500">No programs found.
                                            Create your first program!</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
